...
import { animationContent, animationImg, animationParagraph, animationTitle } from '../../framer-motion/animations'
...
export default function Content (): JSX.Element {
  return (
    <>
      ...
      >
        <main className="mx-auto bg-gray-100 py-10 w-full shadow-lg rounded-lg md:rounded-none">
