  ...
  return (
    ...
    >
      <section>
        ...
        >Bienvenida <span className="text-[#FF0D48]">María Alejandra</span></motion.h2>
        ...
        >A la izquierda tienes el menú para<span className="text-[#FF0D48]">Administrar</span></motion.p>
        ...
        >Arriba a la derecha tienes el menú para <span className="text-[#FF0D48]">Administrar</span></motion.p>
      </section>
    </motion.article>
  )
}
